...
extern "C" {
    ...
    pub fn initialize_crafter__web_CrafterWeb(builtin: u8) -> *mut lean_object;
    ...
    pub fn lithe_stream_push_body(req_id: u64, chunk: *mut lean_object, is_last: u64) -> *mut lean_object;
